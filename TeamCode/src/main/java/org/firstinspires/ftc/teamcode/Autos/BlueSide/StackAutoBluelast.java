...
@Config
@Autonomous(name = "StackAutoBluelast", group = "Autonomous")
public class StackAutoBluelast extends LinearOpMode {
...
//    public static double turn3 = 90;
    ...
    public static double backdropMiddleX = 57;
    public static double backdropMiddleY = 41.5;
    public static double backdropMiddleAngle = trussAngle;
    public static double backdropLeftX = 57;
    public static double backdropRightX = 57.5;
