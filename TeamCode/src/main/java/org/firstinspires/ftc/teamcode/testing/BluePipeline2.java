...
public class BluePipeline2 extends OpenCvPipeline {
    Telemetry telemetry;
    Mat mat = new Mat();
...
//    public static double front_y2 = 115;
    ...
    public static double COLOR_THRESHOLD_AMOUNT = 1080;
    public BluePipeline2(Telemetry t) { telemetry = t; }
    ...
    public Mat processFrame(Mat input) {
        ...
        double rightValue = Core.sumElems(right).val[0] / 255;
...
//        telemetry.addData("Front Percentage", Math.round(frontValue * 100) + "%");
        ...
        boolean pixelRight = rightValue > COLOR_THRESHOLD_AMOUNT;
        boolean pixelFront = frontValue > COLOR_THRESHOLD_AMOUNT;
        ...
        if (pixelRight && pixelFront) {
            if(rightValue>=frontValue){
                ...
                location = BluePipeline2.Location.RIGHT;
            }
            else{
                positionMain = "middle";
                telemetry.addData("Pixel Location", "front");
                location = BluePipeline2.Location.FRONT;
            }
            ...
            positionMain = "left";
            location = BluePipeline2.Location.LEFT;
