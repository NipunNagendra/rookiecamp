...
@Config
@Autonomous(name = "StackAutoRedSplines", group = "Autonomous")
public class StackAutoRedSplines extends LinearOpMode {
...
//                .turn(Math.toRadians(90))
        ...
        TrajectorySequence goToBackdropLeft = drive.trajectorySequenceBuilder(goToStackRight.end())
                .setReversed(true)
                .back(2)
        ...
        TrajectorySequence goToBackdropMiddle = drive.trajectorySequenceBuilder(goToStackMiddle.end())
                // to backdrop
                .setReversed(true)
                .back(2)
        ...
        TrajectorySequence goToBackdropRight = drive.trajectorySequenceBuilder(goToStackRight.end())
                .setReversed(true)
                .back(2)
                .splineTo(new Vector2d(preTrussX, trussY), Math.toRadians(0))
                .lineTo(new Vector2d(trussX, trussY),
