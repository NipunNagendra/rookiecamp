...
@Config
@Autonomous(name = "StackAutoBluerobopirates", group = "Autonomous")
public class StackAutoBlueroborpirates extends LinearOpMode {
...
//    public static double turn3 = 90;
    ...
    public static double backdropLeftStrafe = 12;
