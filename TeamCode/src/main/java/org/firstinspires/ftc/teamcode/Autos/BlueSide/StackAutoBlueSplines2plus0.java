...
@Config
@Autonomous(name = "StackAutoBlueSplines2+0", group = "Autonomous")
public class StackAutoBlueSplines2plus0 extends LinearOpMode {
...
//    public static double turn3 = 90;
    ...
    public static double trussY = 62.2;
    ...
    public static double backdropMiddleX = 58.1;
    public static double backdropMiddleY = 41.5;
    public static double backdropMiddleAngle = trussAngle;
    public static double backdropLeftX = 58.1;
    public static double backdropRightX = 57.7;
...
//                .lineToLinearHeading(new Pose2d(preTrussX + 1, trussY, trussAngle))
                ...
                .lineToLinearHeading(new Pose2d(backdropRightX, backdropMiddleY - backdropRightStrafe, backdropMiddleAngle),
                        SampleMecanumDrive.getVelocityConstraint(15, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .build();
        ...
        TrajectorySequence goToBackdropLeft = drive.trajectorySequenceBuilder(scorePurpleLeft.end())
                ...
                .lineToLinearHeading(new Pose2d(backdropLeftX, backdropMiddleY + backdropRightStrafe, backdropMiddleAngle),
                        SampleMecanumDrive.getVelocityConstraint(15, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .build();
