...
@Config
@Autonomous(name = "StackAutoRedMatch7", group = "Autonomous")
public class StackAutoRedMatch7 extends LinearOpMode {
    ...
    public static double spike2Y = -30.023006373520104;
...
//    public static double turn3 = 90;
    ...
    public static double moveBackwards3 = 29;    public static double moveForward3 = 12;
    public static double turn3 = 90;
