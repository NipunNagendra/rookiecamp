...
//
//        //still need to enter values for these
//        TrajectorySequence spikeToStack =  drive.trajectorySequenceBuilder(posEstimate)
//                .lineToLinearHeading(new Pose2d(whiteStackX, whiteStackY, whiteStackAngle))
//                .build();
//
//        //still need to enter values for these
//        TrajectorySequence whiteStackToBackDropLeft = drive.trajectorySequenceBuilder(spikeToStack.end())
//                .lineToLinearHeading(new Pose2d(backDrop1X, backDrop1Y, backDrop1Angle))
//                .build();
//
//        //still need to enter values for these
//        TrajectorySequence whiteStackToBackDropMiddle = drive.trajectorySequenceBuilder(spikeToStack.end())
//                .lineToLinearHeading(new Pose2d(backDrop2X , backDrop2Y, backDrop2Angle))
//                .build();
//
//        //still need to enter values for these
//        TrajectorySequence whiteStackToBackDropRight = drive.trajectorySequenceBuilder(spikeToStack.end())
...
//                    ElapsedTime limit = new ElapsedTime(ElapsedTime.Resolution.SECONDS);
//                    manip.intakeServoHeights(5);
//                    while (manip.beamBreakUpper() == false && limit.time()<=6){
//                        manip.setIntakePower(.5);
//                    }
//                    manip.setIntakePower(0);
//                    manip.intakeServoHeights(1);
