...
//    public static double front_y2 = 115;
    ...
    public RedPipeline2(Telemetry t) { telemetry = t; }
...
//        telemetry.addData("Front Percentage", Math.round(frontValue * 100) + "%");
        ...
        if (pixelRight && pixelFront) {
            if(rightValue>=frontValue){
                ...
                location = RedPipeline2.Location.RIGHT;
            }
            else{
                positionMain = "middle";
                telemetry.addData("Pixel Location", "front");
                location = RedPipeline2.Location.FRONT;
            }
            ...
            positionMain = "left";
            location = RedPipeline2.Location.LEFT;
